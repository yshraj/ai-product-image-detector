...
reported via [GitHub Security Advisories](https://github.com/yshraj/ai-product-image-detector/security/advisories/new)
(for a private channel) or by opening a GitHub issue if the report doesn't
need to stay private. All complaints will be reviewed and investigated
promptly and fairly.
