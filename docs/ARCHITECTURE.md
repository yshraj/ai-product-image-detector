...
**Architectural invariant:** No TrueKart backend. All logic runs in the user's browser. The optional BYOK (Hugging Face) sends traffic directly from the extension to that third party.
